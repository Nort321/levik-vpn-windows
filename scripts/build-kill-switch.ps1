...
$command = 'call "{0}" && cl.exe /nologo /std:c++17 /EHsc /W4 /WX /DUNICODE /D_UNICODE /O2 /MT "{1}" /Fo:"{2}" /Fe:"{3}" /link fwpuclnt.lib iphlpapi.lib rpcrt4.lib userenv.lib' -f $vcvars, $source, $object, $executable
