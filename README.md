...
- Цветовой индикатор подключения в системном трее и OTA-обновления с явными шагами загрузки и установки.
...
Приложение написано на TypeScript и Electron. Для VPN-подключения используется [Xray-core](https://github.com/XTLS/Xray-core) с небольшой поправкой сравнения имён процессов Windows без учёта регистра. Бинарный файл не хранится в Git: GitHub Actions проверяет контрольные суммы исходного кода и официальных runtime-ресурсов, применяет версионируемый патч и собирает ядро; изменённые исходники включены в установщик.
...
Понадобятся Node.js 24, npm, Go 1.26.8, Git, tar и Windows x64:
